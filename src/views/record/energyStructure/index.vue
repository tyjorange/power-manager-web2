  ...
  <section style="padding: 10px;">
    <el-row style="padding: 10px 20px;">
      <el-col :span="6">
        ...
        <el-tree :data="collectorList" :props="defaultProps" accordion ref="collectorTree" node-key="id" @node-click="getSwiths"
          style="margin-top: 10px;"></el-tree>
      </el-col>
      <el-col :span="18" style="float:right;">
        <div style="margin-bottom: 10px;">
          <el-input v-model="input_collector" placeholder="请输入计量点名称/通讯地址" size="mini" style="width:300px"></el-input>
        ...
        <template>
          <el-table :data="tableData" ref="multipleTable" stripe border highlight-current-row style="width: 100%"
            :header-cell-style="tableHeaderColor" size="mini" v-loading="listLoading" element-loading-text="加载中"
