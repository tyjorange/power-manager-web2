...
<template>
  <section style="padding: 10px;">
    <el-button @click="dialogFormVisible = true" type="primary" size="mini" style="margin: 10px;float:right;">添加</el-button>

    <!--地图容器-->
    <div id="myMap" class="myMap"></div>

    <!-- Form -->
    <el-dialog title="企业信息" :visible.sync="dialogFormVisible" width="70%" style="margin-top: -5vh;">
          ...
          <el-col :span="11">
            <el-form-item label="所属行业" prop="industry">
              <el-select v-model="ruleForm.industry" placeholder="请选择所属行业">
                <el-option label="第一产业" value="shanghai"></el-option>
                <el-option label="第二产业" value="beijing"></el-option>
                <el-option label="第三产业（服务业）" value="beijing"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="企业类型">
          <el-col :span="11">
            <el-select v-model="ruleForm.enterpriseType" placeholder="请选择企业类型">
              <el-option label="园林能效" value="1"></el-option>
            </el-select>
          </el-col>
          <el-col :span="11">
            <el-form-item label="企业类别" prop="businessCategory">
              <el-select v-model="ruleForm.businessCategory" placeholder="请选择企业类别">
                <el-option label="国家监管" value="1"></el-option>
                <el-option label="省级监管" value="2"></el-option>
                <el-option label="各地市监管" value="3"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="电子邮箱" prop="email">
          ...
          <el-col :span="11">
            <el-form-item label="主要经营活动" prop="activities">
              <el-input v-model="ruleForm.activities"></el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="企业等级">
          <el-col :span="11">
            <el-select v-model="ruleForm.enterpriseType" placeholder="请选择企业等级">
              <el-option label="顶级公司" value="1"></el-option>
